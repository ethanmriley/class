...
void StudentTest(){
	double get_val = -9999;
	Matrix M(3, 4, 5);
	std::cout << "Matrix M(3, 4, 5)";
	std::cout << M;
	M.transpose();
	std::cout << "M.transpose()";
	std::cout << M;
	M.resize(2, 3, 10);
	std::cout << "M.resize(2, 3, 10)";
	std::cout << M;
	M.resize(5, 5, 7);
	std::cout << "M.resize(5, 5, 7)";
	std::cout << M;
	M.resize(5, 5, 7);
	std::cout << "M.resize(5, 5, 7)";
	std::cout << M;
	M.resize(0, 0, 0);
	std::cout << "M.resize(0, 0, 0)";
	std::cout << M;
	M.resize(5, 5, 5);
	std::cout << "M.resize(5, 5, 5)";
	std::cout << M;
	Matrix M1 = M;
	M1.resize(0, 0, 0);
	M1.resize(5, 5, 0);
	M.add(M1);
	std::cout << "M.add(0 matrix)";
	std::cout << M;
	M.resize(5, 0, 0);
	std::cout << "M.resize(5, 0, 0)";
	std::cout << M;
	M.transpose();
	std::cout << "M.transpose()";
	std::cout << M;
	...
	std::cout << quarters[3];
	M.subtract(M1);
	std::cout << "M.subtract(empty matrix)";
	std::cout << M;
	bool result = M.set(10, 10, 13);
	std::cout << "M.set(10, 10, 13)" << std::endl;
	std::cout << result << M;
	result = M.get(10, 10, get_val);
	std::cout << "M.get(10, 10, 13)" << std::endl;
	std::cout << result << " " << get_val << M;
	M.clear();
	std::cout << "M.clear()";
	std::cout << M;
	M.clear();
	...
	std::cout << M;
	M.resize(4, 4, 4);
	M.multiply_by_coefficient(0);
	std::cout << "M.resize(4, 4, 4)" << std::endl << "M.multiply_by_coefficient(0)";
	std::cout << M;
	delete [] quarters;
}
